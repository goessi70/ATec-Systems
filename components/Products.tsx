      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-xl">
            ...
            <h2 className={`text-2xl md:text-4xl font-black mb-8 tracking-normal ${isDark ? 'text-white' : 'text-slate-900'}`}>{t.catalogTitle}</h2>
          </div>
          ...
          <div ref={viewerRef} className="mt-32 pt-32 border-t border-slate-800/10 animate-fadeIn">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
              <div>
                ...
                <h2 className={`text-2xl md:text-4xl font-black tracking-normal ${isDark ? 'text-white' : 'text-slate-900'}`}>
